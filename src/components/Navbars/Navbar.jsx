...
function Navbar() {
  ...
  return (
    <>
      <header>
        <div className="h-20 flex items-center gap-2 sm:gap-4 justify-between px-4 sm:px-7 lg:px-10 bg-amber-50">
          ...
          <div className="flex gap-5 items-center">
            {isHome && <form className="transition-all duration-75 sm:flex hidden items-center h-10 self-center overflow-hidden shrink">
            ...
            <ul className="flex gap-2 sm:gap-4">
              <li>
                <Link to="/cart" className="relative" onClick={() => setIsHome(false)}>
                  ...
                  <div className="absolute -top-2 bg-[#e18544] rounded-full px-1 left-6 text-white">1</div>
                </Link>
              </li>
              <li className="hidden sm:block">
                <Link to="/admin" className="relative" onClick={() => setIsHome(false)}>
                  ...
                  <div className="absolute -top-2 bg-[#e18544] rounded-full px-1 left-5 text-white">1</div>
                </Link>
              </li>
              <li className="block sm:hidden relative">
                ...
                <div className="absolute -top-2 bg-[#e18544] rounded-full px-1 left-7 text-white">1</div>
              </li>
            </ul>
          </div>
        </div>
        {isHome && <nav className="bg-amber-100 py-1 flex justify-center">
          <form className="flex sm:hidden items-center h-11 self-center overflow-hidden mx-2 w-auto shrink">
