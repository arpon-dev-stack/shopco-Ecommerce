          ...
          <div className="flex gap-5 items-center">
            ...
            <ul className="flex items-center gap-2 sm:gap-4">
              ...
              <li className="hidden sm:flex items-center">
                <Link to="/admin" className="relative flex items-center" onClick={() => setIsHome(false)}>
                  ...
                  <div className="absolute sm:-top-2 -top-0 bg-[#e18544] rounded-full px-1 left-5 text-white">1</div>
                </Link>
              </li>
              <li className="flex items-center sm:hidden relative w-11 h-11 sm:w-auto sm:h-auto">
                ...
                <div className="absolute sm:-top-2 -top-0 bg-[#e18544] rounded-full px-1 left-7 text-white">1</div>
              </li>
            </ul>
          </div>
        </div>
